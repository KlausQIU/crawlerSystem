...
from settings import get_app_label,PROJECT_ROOT
import traceback
import os,glob
...
class DictDefine(models.Model,BaseModelMixin):   
    ...
    key = models.CharField('标识名',max_length=50,unique=True,default=get_default_key(),db_index=True)
    _dict = models.TextField('存键值',default=get_default_dict())
